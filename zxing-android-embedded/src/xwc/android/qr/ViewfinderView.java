...
public class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawLine(frame.left + 20, slideTop, frame.right - 20, slideTop, paint);
            ...
            int ll = frame.width() / 8;
            canvas.drawRect(frame.left, frame.top, frame.left + ll, frame.top + 5, paint);
            canvas.drawRect(frame.left, frame.top, frame.left + 5, frame.top + ll, paint);
            canvas.drawRect(frame.right - ll, frame.top, frame.right, frame.top + 5, paint);
            canvas.drawRect(frame.right - 5, frame.top, frame.right, frame.top + ll, paint);
            canvas.drawRect(frame.left, frame.bottom - 5, frame.left + ll, frame.bottom, paint);
            canvas.drawRect(frame.left, frame.bottom - ll, frame.left + 5, frame.bottom, paint);
            canvas.drawRect(frame.right - ll, frame.bottom - 5, frame.right, frame.bottom, paint);
            canvas.drawRect(frame.right - 5, frame.bottom - ll, frame.right, frame.bottom, paint);

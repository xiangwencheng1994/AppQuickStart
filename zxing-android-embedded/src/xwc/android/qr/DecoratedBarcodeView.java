...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (barcodeView == null) {
            throw new IllegalArgumentException(
                "There is no a xwc.android.qr.BarcodeView on provided layout " +
        ...
        if (viewFinder == null) {
            throw new IllegalArgumentException(
                "There is no a xwc.android.qr.ViewfinderView on provided layout " +
    ...
    public boolean toggleTorch(){
        boolean torch = ! barcodeView.getTorch();
        barcodeView.setTorch(torch);
        return torch;
    }
